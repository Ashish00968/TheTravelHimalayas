...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/safety`, lastModified, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/plan`, lastModified, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/plan/trek-finder`, lastModified, changeFrequency: "weekly", priority: 0.85 },
    { url: `${BASE_URL}/plan/compare`, lastModified, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/plan/season`, lastModified, changeFrequency: "weekly", priority: 0.8 },
    { url: `${BASE_URL}/plan/budget`, lastModified, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/plan/packing`, lastModified, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE_URL}/prepare`, lastModified, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/disclaimer`, lastModified, changeFrequency: "yearly", priority: 0.4 },
